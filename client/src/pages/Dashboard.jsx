...
const TaskTable = ({ tasks }) => {
  ...
  const TableRow = ({ task }) => (
    <tr className='border-b border-gray-300 text-gray-600 hover:bg-gray-10'>
      <td className='py-2'>
...
const TableRow = ({ user }) => (
  ...
  return (
    <div className='w-full md:w-1/3 bg-white px-2 md:px-4 pt-4 pb-4 shadow-md rounded'>
...
const Dashboard = () => {
  ...
  return <div className='h-full py-4'>
    ...
    <div className='w-full flex flex-col md:flex-row gap-4 2xl:gap-10 py-8'>
      ...
      <UserTable users={summary.last10Users} />
    </div>
  </div>
}
